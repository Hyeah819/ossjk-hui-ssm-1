						...
						<div class="row clearfix">
							<div class="col-xs-12 col-sm-6 col-md-4">
								<div class="row clearfix mb-10">
									<span class="col-xs-4 form-item-label">姓名：</span> <span class="col-xs-4 form-item-control"> <input type="text" name="name"   value="${requestScope.name }" placeholder="" class="input-text" />		
									</span>
								</div>
								<div class="row clearfix mb-10">
									<span class="col-xs-4 form-item-label">部门：</span> <span class="col-xs-4 form-item-control"><input type="text"  name="oname" value="${requestScope.oname }" placeholder="" class="input-text">
									</span>
								</div>
								<div class="row clearfix mb-10">
									<span class="col-xs-4 form-item-label">手机：</span> <span class="col-xs-4 form-item-control"><input type="text" name="phone" value="${requestScope.phone }" placeholder="" class="input-text">
									</span>
								</div>
								<div class="row clearfix mb-10">
									<span class="col-xs-4 form-item-label">邮箱：</span> <span class="col-xs-4 form-item-control"><input type="text" name="email" value="${requestScope.email }" placeholder="@" class="input-text">
									</span>
								</div>
							</div>
